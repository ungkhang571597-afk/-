    ...
    <style>
      * { box-sizing: border-box; }
      ...
      .portfolio-card .media {
        min-height: 260px;
        background:
          linear-gradient(135deg, rgba(32, 25, 20, .76), rgba(32, 25, 20, .12)),
          linear-gradient(90deg, rgba(255, 252, 245, .18) 0 1px, transparent 1px) 0 0 / 28px 28px,
          linear-gradient(0deg, rgba(255, 252, 245, .12) 0 1px, transparent 1px) 0 0 / 28px 28px,
          url('../assets/brand/portrait-zt-card.webp') center / cover no-repeat;
        border-bottom: 0;
...
<html lang="zh-CN">
  ...
  <body>
    <main class="shell">
      <a class="top-link" href="preview.html">返回总入口</a>
      <header>
        <div>
          <h1>作品集账号归档</h1>
        </div>
      ...
      <section class="summary" aria-label="账号归档概览">
        ...
        <article><strong>7</strong><span>账号入口</span></article>
        <article><strong>2</strong><span>主要平台</span></article>
      </section>
