  ...
  <body>
    <main class="shell">
      ...
      <section class="summary" aria-label="账号归档概览">
        ...
        <article><strong>16</strong><span>账号入口</span></article>
      ...
      <section class="projects" aria-label="账号列表">
        ...
        <article class="project">
          ...
          <div class="accounts">
            <div class="account">
              <span class="platform">小红书</span>
              <div><strong>颜执餐饮美学培训</strong><small>餐饮培训 / 小红书账号 1</small></div>
            ...
            <div class="account">
              <span class="platform">抖音</span>
              <div><strong>颜执泰餐培训</strong><small>餐饮培训 / 抖音账号</small></div>
              <a class="open" href="https://www.douyin.com/user/MS4wLjABAAAAOhpMBzhF1h0-0TVEgjcOsetQCVanAO8TKLL9ma-Pzqng3IS9Z_aoh3BGB6bqFfjC?from_tab_name=main" target="_blank" rel="noopener noreferrer">打开账号</a>
            </div>
            <div class="account">
              <span class="platform">抖音</span>
              <div><strong>颜执餐饮美学培训</strong><small>餐饮培训 / 抖音账号</small></div>
              <a class="open" href="https://www.douyin.com/user/MS4wLjABAAAA_A-tDMb3eMMVV3izR5MKIq2UZ9utf8QMSM84vCFngFY?from_tab_name=main" target="_blank" rel="noopener noreferrer">打开账号</a>
            </div>
          </div>
        </article>
      </section>
